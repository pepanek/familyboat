...
--
-- Počítač: 127.0.0.1
-- Vygenerováno: Čtv 26. pro 2013, 18:37
...
DROP TABLE IF EXISTS `fb_associations`;
...
DROP TABLE IF EXISTS `fb_banners`;
...
DROP TABLE IF EXISTS `fb_banner_clients`;
...
DROP TABLE IF EXISTS `fb_banner_tracks`;
...
DROP TABLE IF EXISTS `fb_contact_details`;
...
DROP TABLE IF EXISTS `fb_content`;
...
DROP TABLE IF EXISTS `fb_contentitem_tag_map`;
...
DROP TABLE IF EXISTS `fb_content_frontpage`;
...
DROP TABLE IF EXISTS `fb_content_rating`;
...
DROP TABLE IF EXISTS `fb_content_types`;
...
DROP TABLE IF EXISTS `fb_core_log_searches`;
...
DROP TABLE IF EXISTS `fb_extensions`;
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"730f1ef266ca91b1bd61acf3adda707b"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
DROP TABLE IF EXISTS `fb_finder_filters`;
...
DROP TABLE IF EXISTS `fb_finder_links`;
...
DROP TABLE IF EXISTS `fb_finder_links_terms0`;
...
DROP TABLE IF EXISTS `fb_finder_links_terms1`;
...
DROP TABLE IF EXISTS `fb_finder_links_terms2`;
...
DROP TABLE IF EXISTS `fb_finder_links_terms3`;
...
DROP TABLE IF EXISTS `fb_finder_links_terms4`;
...
DROP TABLE IF EXISTS `fb_finder_links_terms5`;
...
DROP TABLE IF EXISTS `fb_finder_links_terms6`;
...
DROP TABLE IF EXISTS `fb_finder_links_terms7`;
...
DROP TABLE IF EXISTS `fb_finder_links_terms8`;
...
DROP TABLE IF EXISTS `fb_finder_links_terms9`;
...
DROP TABLE IF EXISTS `fb_finder_links_termsa`;
...
DROP TABLE IF EXISTS `fb_finder_links_termsb`;
...
DROP TABLE IF EXISTS `fb_finder_links_termsc`;
...
DROP TABLE IF EXISTS `fb_finder_links_termsd`;
...
DROP TABLE IF EXISTS `fb_finder_links_termse`;
...
DROP TABLE IF EXISTS `fb_finder_links_termsf`;
...
DROP TABLE IF EXISTS `fb_finder_taxonomy`;
...
DROP TABLE IF EXISTS `fb_finder_taxonomy_map`;
...
DROP TABLE IF EXISTS `fb_finder_terms`;
...
DROP TABLE IF EXISTS `fb_finder_terms_common`;
...
DROP TABLE IF EXISTS `fb_finder_tokens`;
...
DROP TABLE IF EXISTS `fb_finder_tokens_aggregate`;
...
DROP TABLE IF EXISTS `fb_finder_types`;
...
DROP TABLE IF EXISTS `fb_menu_types`;
...
DROP TABLE IF EXISTS `fb_messages`;
...
DROP TABLE IF EXISTS `fb_messages_cfg`;
...
DROP TABLE IF EXISTS `fb_modules_menu`;
...
DROP TABLE IF EXISTS `fb_newsfeeds`;
...
DROP TABLE IF EXISTS `fb_overrider`;
...
DROP TABLE IF EXISTS `fb_postinstall_messages`;
...
DROP TABLE IF EXISTS `fb_redirect_links`;
...
DROP TABLE IF EXISTS `fb_schemas`;
...
('25g73edqvq4qeaplg0b2lslff4', 1, 0, '1388078449', '__default|a:8:{s:15:"session.counter";i:43;s:19:"session.timer.start";i:1388076883;s:18:"session.timer.last";i:1388078446;s:17:"session.timer.now";i:1388078448;s:22:"session.client.browser";s:65:"Mozilla/5.0 (Windows NT 5.1; rv:26.0) Gecko/20100101 Firefox/26.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":3:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:11:"com_modules";O:8:"stdClass":3:{s:4:"edit";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:4:"data";N;s:2:"id";a:0:{}}}s:3:"add";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:12:"extension_id";N;s:6:"params";N;}}s:7:"modules";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:18:"client_id_previous";i:0;}}}s:11:"com_content";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:7:"article";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}}}}}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"683";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:18:"pepa@familyboat.cz";s:8:"password";s:34:"$P$DWPB0hWN10Uf6oK0SfKl2YJTKrYIwr/";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-12-17 19:16:49";s:13:"lastvisitDate";s:19:"2013-12-26 15:36:08";s:10:"activation";s:1:"0";s:6:"params";s:2:"{}";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"cd45dfe057db8815b7e87f56b5bc21aa";}__wf|a:1:{s:13:"session.token";s:32:"43252534f60b5c9a2af83fe51b87d8ef";}', 683, 'admin'),
('imo2qj7t13cekdtg82f9dod6n0', 0, 1, '1388078357', '__default|a:8:{s:15:"session.counter";i:12;s:19:"session.timer.start";i:1388076956;s:18:"session.timer.last";i:1388078344;s:17:"session.timer.now";i:1388078357;s:22:"session.client.browser";s:65:"Mozilla/5.0 (Windows NT 5.1; rv:26.0) Gecko/20100101 Firefox/26.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:2:"13";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:1:{i:0;s:1:"1";}s:14:"\\0\\0\\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:16:"com_mailto.links";a:3:{s:40:"f9e62a9ca1f5f0c39ebd0426bfa1c26363226374";O:8:"stdClass":2:{s:4:"link";s:55:"http://localhost/familyboat/index.php/8-novinky/3-news2";s:6:"expiry";i:1388077131;}s:40:"c88181e98a2e7e47ebb2f4b885884b3e6ef42bf6";O:8:"stdClass":2:{s:4:"link";s:68:"http://localhost/familyboat/index.php/nase-sluzby/8-novinky/2-news-1";s:6:"expiry";i:1388077654;}s:40:"5956d35c6ad63fe9755ef537ae436d434d8db395";O:8:"stdClass":2:{s:4:"link";s:66:"http://localhost/familyboat/index.php/destinace/8-novinky/2-news-1";s:6:"expiry";i:1388077913;}}}', 0, '');
...
DROP TABLE IF EXISTS `fb_template_styles`;
...
DROP TABLE IF EXISTS `fb_ucm_base`;
...
DROP TABLE IF EXISTS `fb_ucm_content`;
...
DROP TABLE IF EXISTS `fb_ucm_history`;
...
DROP TABLE IF EXISTS `fb_updates`;
...
DROP TABLE IF EXISTS `fb_update_sites`;
...
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1388072173),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1388072173),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1388072173),
(4, 'Accordeon Menu CK Update', 'extension', 'http://update.joomlack.fr/mod_accordeonck_update.xml', 1, 1388072173),
(5, 'JCE Editor Updates', 'extension', 'https://www.joomlacontenteditor.net/index.php?option=com_updates&view=update&format=xml&id=1', 1, 1388072173),
(6, 'JCE Editor Updates', 'extension', 'https://www.joomlacontenteditor.net/index.php?option=com_updates&view=update&format=xml&id=1&file=extension.xml', 1, 1388072173);
...
DROP TABLE IF EXISTS `fb_update_sites_extensions`;
...
DROP TABLE IF EXISTS `fb_usergroups`;
...
(683, 'Super User', 'admin', 'pepa@familyboat.cz', '$P$DWPB0hWN10Uf6oK0SfKl2YJTKrYIwr/', 0, 1, '2013-12-17 19:16:49', '2013-12-26 16:54:45', '0', '{}', '0000-00-00 00:00:00', 0, '', '');
...
DROP TABLE IF EXISTS `fb_user_keys`;
...
DROP TABLE IF EXISTS `fb_user_notes`;
...
DROP TABLE IF EXISTS `fb_user_profiles`;
...
DROP TABLE IF EXISTS `fb_user_usergroup_map`;
...
DROP TABLE IF EXISTS `fb_viewlevels`;
...
DROP TABLE IF EXISTS `fb_weblinks`;
...
DROP TABLE IF EXISTS `fb_wf_profiles`;
