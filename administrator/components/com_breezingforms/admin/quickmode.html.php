...
>			            		<?php
						...
						$dbObject = Zend_Json::decode($dataObjectString);
			            		...
			            		<input type="checkbox" value="" id="bfElementAdvancedMobileEnabledLite"/>
			            		...
			            		<input type="checkbox" value="" id="bfElementAdvancedForceMobileLite"/>
                                                <input type="hidden" value="" id="bfElementAdvancedForceMobile"/>
                                                <br/>
			            		<br/>
			            		...
			            		<input type="text" value="" id="bfElementAdvancedForceMobileUrlLite"/>
			            ...
			            <div class="bfAdvanced" id="bfElementAdvanced" style="display:none">
			            	...
			            	<fieldset>
			            		...
			            		<div class="bfElementTypeClass" id="bfElementTypeFileAdvanced" style="display:none">
			            			...
			            			<input type="checkbox" value="" id="bfElementFileAdvancedHtml5UploaderLite"/>
                                                        <input type="hidden" value="" id="bfElementFileAdvancedHtml5Uploader"/>
			            			<br/>
			            			<br/>
